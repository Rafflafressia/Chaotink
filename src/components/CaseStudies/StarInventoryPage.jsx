...
const StarInventoryPage = () => {
  ...
  return (
    <div className="space-y-4 pt-16 pb-4 lg:mx-32 xl:mx-48 2xl:mx-[500px]">
      ...
      <Section title="Application Overview" headingClass={headingsOne} />
        ...
        buttons={[
          {
            ...
            link: "https://star-inventory-logistics-36c6a2954dc4.herokuapp.com/login",
          },
          {
            text: "GitHub Repository",
            link: "https://github.com/Rafflafressia/Star-Inventory-Logistics",
          },
        ]}
      />
    </div>
