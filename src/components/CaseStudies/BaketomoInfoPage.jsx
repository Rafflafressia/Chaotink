  ...
  return (
    <div className="py-8 xl:mx-72">
        ...
        <div className="flex flex-col justify-center items-start">
          ...
          <div className="flex flex-col justify-center items-start bg-gray-200 m-2 p-4 rounded-[10px]">
            ...
            <ol className="list-decimal list-inside text-[15px] mx-4 space-y-2 xl:text-[20px] xl:mx-8">
              ...
              <li>
                Players encounter a boss monster after a set number of
                encounters,
              </li>
              <li>
                Players always have a chance to capture the boss monster upon
                defeating it,
              </li>
              <li>
      ...
      <div className="border-t-[0.5px] border-gray p-2 m-2">
        ...
        <p className="italic text-gray-400 mx-36">
          Click and drag left and right to cycle through images (swipe on
          mobile)
        </p>
        ...
        <div>
          ...
          <div className="my-2">
            ...
            <p className="text-xl">
              ...
              monster has unique stats and abilities to defeat other monsters.
            </p>
          </div>
          <div className="my-2">
          ...
          <div className="my-2">
            ...
            <p className="text-xl">
              Players can enhance their experience by purchasing items from the
              shop. Items can increase the rate for rare monsters or drops, heal
              active monsters between encounters, or guarantee monster captures.
            </p>
          </div>
        </div>
        <img
        ...
        <div className="flex flex-col justify-center items-center lg:flex-row xl:mx-36">
          ...
          <div className="glass flex flex-col justify-center items-center bg-green-900 bg-opacity-10 mx-4 shadow-[0px_4px_23px_5px_rgba(0,0,0,0.25)] rounded-[10px] my-2 p-4 space-y-4">
            ...
            >
              ...
              can log in, sign up, choose a starter, go into a dungeon, fight a
              random boss monster, and capture it.
              <br />
              <br /> Players can also swap out their active monster from the
              Monster Closet and change their password.
              <br />
              <br /> We are actively working on improving the game experience
              and hope to have a fully functional product soon. Until then,
              please click on the logo below to check out Baketomo!
              <br />
              <br /> Please note that this project was designed to be played on
              an iPhone SE but will work fine on any other mobile device.
            </p>
            <img
              src={BaketomoLogo}
              alt="Baketomo Logo"
      ...
      <div className="flex flex-col border-t-[0.5px] border-gray p-2 my-4 mx-2 lg:mx-12 xl:flex-row xl:mx-36">
        <div>
          ...
          <div className="my-2">
            ...
            <p className="text-xl">
              Our current state of play allows players to capture monsters by
              pressing a button. For future development, we want to refine this
              process by allowing players to deplete the monster's HP, negotiate
              a contract, or form a temporary alliance for unique loot.
            </p>
          </div>
          <div className="my-2">
            <h3 className="text-2xl font-bold">Explore</h3>
            <p className="text-xl">
              Currently, players engage with monsters immediately upon entering
              a dungeon. For future development, we want to create a more
              rewarding experience by adding rooms, traps, and puzzles.
            </p>
          </div>
          <div className="my-2">
            <h3 className="text-2xl font-bold">Enhance</h3>
            <p className="text-xl">
              Currently, players can only purchase packs to obtain new monsters.
              For future development, we aim to link the shop experience to the
              game, offering items to heal monsters, reveal secrets, and
              increase the odds of encountering specific monsters.
            </p>
          </div>
        </div>
        <img
