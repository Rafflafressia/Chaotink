...
import ScreenshotOne from "../../assets/answerables-screenshot-1.jpeg";
                    ...
                    <div className="flex flex-col justify-center items-center bg-gray-200 m-2 p-4 rounded-[10px] 2xl:flex-row">
                        <div className="mx-auto my-4 space-y-4">
                            ...
                            <p className="">
                                ...
                                complete modules to receive rewards and cosmetics as they do so.
                            </p>
                        </div>
                        <img src={ScreenshotFour} alt="Screenshot of Alien from Answerables" className="invisible fixed lg:relative lg:visible lg:w-3/6"/>
                    </div>
                </div>
            </div>
            <div className="lg:mx-36 border-t-2 border-gray">
                <h3 className="text-3xl font-bold m-4 xl:text-[40px] xl:m-8">Platform</h3>
                <p className="m-4 xl:m-8">Answerables was completely playable on PC as well as on Tablets.</p>
            </div>
            <div className="lg:mx-36 border-t-2 border-gray">
                <h3 className="text-3xl font-bold m-4 xl:text-[40px] xl:m-8">Controls</h3>
                <div className="flex flex-col lg:flex-row justify-center mx-16">
                    <img src={ScreenshotOne} alt="Screenshot of Screen" className="w-4/12" />
                    <div>
                        <h4 className="m-4 xl:mx-8 md:text-2xl font-bold">Tablet Controls:</h4>
                        <ol className="list-disc m-4 md:text-lg xl:mx-16">
                            <li>Players have an onscreen joystick to move avatar forward, backward and strafe left and right.</li>
