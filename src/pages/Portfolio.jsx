...
const Portfolio = () => {
  ...
  return (
    <div>
      <div className="portfolio-container overflow-y-scroll md:my-[20px] h-screen sm:h-screen lg:my-[100px] md:flex md:h-screen lg:h-[700px] xl:h-[883px] ">
